...
// Skipped from the old site on purpose: "Adult Drama" and "Ancient
// Adventures" were backed by hand-picked title lists (_adultSeries,
// _ancientAdventure) with no clean TMDB-parameter equivalent. Tell me
// what actually defines each (a genre combo? a keyword? a decade
// range?) and I'll wire up a real query instead of a list to maintain.
